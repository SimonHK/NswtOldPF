...
<dl>
<dd><img src='<%=Config.getContextPath()%>AuthCode.jsp' alt='点击刷新验证码' height='14' align='absmiddle' style='cursor:pointer;' onClick="this.src='<%=Config.getContextPath()%>AuthCode.jsp?Height=14&Width=50&'+new Date().getTime()" />&nbsp; <input	name='VerifyCode' type='text' style='width:60px' id='VerifyCode' class='inputText' onfocus='this.select();'/></dd>
</dl>
<%}%>
<dl>
<%
