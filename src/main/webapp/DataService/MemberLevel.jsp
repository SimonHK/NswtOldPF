...
function addSave(){
	...
	Server.sendRequest("com.nswt.cms.dataservice.MemberLevel.add",dc,function(){
...
function save(){
	DataGrid.save("dg1","com.nswt.cms.dataservice.MemberLevel.save",function(){DataGrid.loadData('dg1');});
}
...
function del(){
	...
	Dialog.confirm("确定要删除该项吗？",function(){
		...
		dc.add("IDs",arr.join());
		Server.sendRequest("com.nswt.cms.dataservice.MemberLevel.del",dc,function(){
			var response = Server.getResponse();
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
			...
			<tr>
				...
				<z:datagrid id="dg1" method="com.nswt.cms.dataservice.MemberLevel.dg1DataBind" size="15">
