...
<table width="180" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        <tr>
          <td valign="middle" class="blockTd"><img src="../Icons/icon018a1.gif" />版块列表</td>
        </tr>
        <tr>
          <td style="padding:6px;"> 	
		  <z:tree id="tree1" style="height:410px" method="com.nswt.cms.dataservice.OuterDocument.bbstreeDataBind">
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
        ...
        <tr>
		  ...
		  <z:datagrid id="dg1" method="com.nswt.cms.dataservice.OuterDocument.bbsDataBind" size="12">
