...
function genDbSrc(){
	...
	if(!arr||arr.length==0){
		Dialog.alert("请先选择要生成代码的表！");
		return;
	}

	Dialog.confirm("确认要生成代码吗？",function(){
	...
	<table width="100%" border="0" cellspacing="6" cellpadding="0" style="border-collapse: separate; border-spacing: 6px;">
      <tr valign="top">
        <td><table width="100%" border="0" cellspacing="0" cellpadding="6" class="blockTable">
            <tr>
              <td valign="middle" class="blockTd"><img src="../Icons/icon005a1.gif" width="20" height="20" /> 数据列表</td>
            </tr>
				<tr>
				...
				<z:tbutton onClick="editForm()"><img src="../Icons/icon002a1.gif" width="20" height="20" />表单</z:tbutton>
				<z:tbutton onClick="conn()"><img src="../Icons/icon006a10.gif" width="20" height="20" />外部连接</z:tbutton>
				<z:tbutton onClick="genDbSrc()"><img src="../Icons/icon015a2.gif" width="20" height="20" />创建代码</z:tbutton>
			 </td>
            </tr>
            <tr>
