...
function showADContent() {
  ...
  for(var i=0;i<count;i++){
	  str += "<li><a href="+AD.ADImage[i].imgADLinkUrl+" onClick='adClick(\""+this.SiteID+"\",\""+this.URL+"\",\""+AD.ADImage[i].imgID+"\",\""+AD.ADImage[i].imgADLinkUrl+"\")' target='"+((AD.ADImage[i].imgADLinkTarget == "Old") ? "_self" : "_blank") + "'><img alt='"+AD.ADImage[i].imgADAlt+"' title='"+AD.ADImage[i].imgADAlt+"' src='"+this.UploadFilePath+AD.ADImage[i].ImgPath+"' ";
	  var sizeStr = "";
