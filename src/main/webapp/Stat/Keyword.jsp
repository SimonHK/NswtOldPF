...
Page.onLoad(function(){
	...
	chart = new Chart("Pie3D","Chart1",680,300,"com.nswt.cms.stat.report.SourceReport.getKeywordChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.nswt.cms.stat.report.SourceReport.dgKeywordDataBind"
