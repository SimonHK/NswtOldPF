...
Page.onLoad(function(){
	...
	chart = new Chart("Mixed2D","Chart1",680,250,"com.nswt.cms.stat.report.LoyaltyReport.getReturningRateChartData");
	...
	<tr valign="top">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0"
			...
			<tr>
				...
				<z:datagrid id="dg1"
					method="com.nswt.cms.stat.report.LoyaltyReport.dgReturningRateDataBind"
