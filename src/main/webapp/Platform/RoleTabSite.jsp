...
function save(){
	...
	Server.sendRequest("com.nswt.platform.RoleTabSite.dg1Edit",dc,function(response){
...
<z:datagrid id="dg1" method="com.nswt.platform.RoleTabSite.dg1DataBind" size="14">
			  <table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
				<tr ztype="head" class="dataTableHead">
				  <td  width="4%" ztype="RowNo">序号</td>
				  <td width="13%"><b>应用名称</b></td>
				  <%for(int i=0;i<map.size();i++){%>
