...
function init(){
	...
	Server.sendRequest("com.nswt.platform.RoleTabMenu.getCheckedMenu",dc,function(response){
...
function save(){
	...
	Server.sendRequest("com.nswt.platform.RoleTabMenu.save",dc,function(response){
...
<table  width="100%" border='0' cellpadding='0' cellspacing='0'>
  <tr>
  <z:init method="com.nswt.platform.RoleTabMenu.init">
...
<z:datagrid id="dg1" method="com.nswt.platform.RoleTabMenu.dg1DataBind">
