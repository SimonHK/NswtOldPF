...
function init(){
	...
	Server.sendRequest("com.nswt.platform.UserTabMenu.getCheckedMenu",dc,function(response){
...
function save(){
	...
	Server.sendRequest("com.nswt.platform.UserTabMenu.save",dc,function(response){
...
<table  width="100%" border='0' cellpadding='0' cellspacing='0'>
  <tr>
  <z:init method="com.nswt.platform.UserTabMenu.init">
...
<z:datagrid id="dg1" method="com.nswt.platform.UserTabMenu.dg1DataBind">
