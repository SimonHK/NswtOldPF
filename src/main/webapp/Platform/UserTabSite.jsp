...
function save(){
	...
	Server.sendRequest("com.nswt.platform.UserTabSite.dg1Edit",dc,function(response){
...
<z:datagrid id="dg1" method="com.nswt.platform.UserTabSite.dg1DataBind" size="10">
			  <table width="100%" cellpadding="2" cellspacing="0" class="dataTable">
				<tr ztype="head" class="dataTableHead">
				  <td  width="6%" ztype="RowNo">序号</td>
				  <td width="20%"><b>应用名称</b></td>
				  <%for(int i=0;i<map.size();i++){%>
