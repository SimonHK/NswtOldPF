...
<z:init method="com.nswt.datachannel.DeployCatalog.init">
<form id="form2">
<table width="780" align="center" cellpadding="2" cellspacing="0">
	...
	<tr>
	  <td height="35" colspan="4" align="center" class="tdgrey2"><z:datagrid id="dg1" multiSelect="false" method="com.nswt.datachannel.DeployCatalog.dialogDataBind" page="false" size="8">
        <table width="700" cellpadding="2" cellspacing="0" class="dataTable">
          <tr ztype="head" class="dataTableHead">
            <td width="7%" ztype="Selector" multi='false' field="_RowNo"></td>
            <td width="33%"><b>应用名称</b></td>
