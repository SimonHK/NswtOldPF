...
<%
	...
	if(r==null){
		...
		out.println("<br><br>请在“应用管理”-“应用列表”中选择相应站点，开启“自动建立索引”选项。");
		return;
	}
	DataTable dt = r.Data;
	int total = r.Total;
...
<title>搜索结果_<%=StringUtil.htmlEncode(query)%></title>
<style>
<!--
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="bi">
	<tr>
		...
		<div style="padding: 0 1em; border-top: 1px solid #fff;"><span
			style="float: right;">约有<b><%=total%></b>项符合搜索<b> <%=StringUtil.htmlEncode(query)%>
