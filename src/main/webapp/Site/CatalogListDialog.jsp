...
<table width="100%" cellpadding="0" cellspacing="6" class="cellspacing">
	<tr style="display:none">
		...
		<div style="text-align:left;">&nbsp; 当前站点： <z:init
			method="com.nswt.platform.Application.init">
	...
	<tr>
		<td colspan="2"><z:tree id="tree1" style="height:360px;width:480px;"
								method="com.nswt.cms.site.Catalog.treeDiagDataBind" level="2"
	...
	<tr><td height=30><input type="radio" name="ReferType" value="1" <% if("1".equals(referType)){out.println("checked");}%>><b>完全复制</b>，复制所有字段 
		<input type="radio" name="ReferType" value="2" <% if("2".equals(referType)){out.println("checked");}%>><b>引用复制</b>，只复制标题并链接到原文</td></tr>
  <%}%>
</table>
</form>
</body>
