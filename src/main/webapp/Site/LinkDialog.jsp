...
function onReturnBack(returnID){
	...
	Server.sendRequest("com.nswt.cms.site.Link.getPicSrc",dc,function(response){
...
<z:init method="com.nswt.cms.site.Link.initDialog">
