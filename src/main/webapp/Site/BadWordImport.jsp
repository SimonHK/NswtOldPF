...
<table width="100%" align="center" cellpadding="1" cellspacing="0"	>
	...
	<tr>
		<td width="11%" height="30" align="left">&nbsp;&nbsp;</td>
		<td width="89%" height="30" align="left">选择文件： <z:uploader id="WordsFile" action="../Site/BadWordImportSave.jsp" onComplete="afterUpload" width="290" allowtype="txt" fileMaxSize="20971520" fileCount="1"/>
		</td>
	</tr>
</table>
	</form>
