...
<h1>应用云平台</h1>
<fieldset id="inputs">
	<input id="UserName" type="text" placeholder="用户名" autofocus required onfocus="this.select();">
	<input id="Password" type="password" placeholder="用户密码" required onfocus="this.select();">
...
<fieldset id="actions">
	...
	<%--<input type="submit" id="submit" value="登 录" onclick="return login();">--%>
<a href="">忘记密码?</a><a href="">注册</a><a href="Member/Login.jsp">我的空间</a>
</fieldset>
