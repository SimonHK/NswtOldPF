...
Constant.TreeLevel = "_NSWT_TREE_LEVEL";
Constant.TreeStyle = "_NSWT_TREE_STYLE";
...
Tree.loadData = function(ele,func){
	...
	Server.sendRequest("com.nswt.framework.controls.TreePage.doWork",ele.Params,function(response){
...
Tree.lazyLoad = function(ele,func){
	...
	Server.sendRequest("com.nswt.framework.controls.TreePage.doWork",tree.Params,function(response){
