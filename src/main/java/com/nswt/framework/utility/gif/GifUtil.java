package com.nswt.framework.utility.gif;
...
import com.nswt.framework.utility.ImageJDKUtil;
...
public class GifUtil {
	...
	public static void main(String[] args) {
		try {
//			ImageJDKUtil.scaleRateImageFile("F:/Document/My Pictures/复件 1.gif", "G:/1.gif", 0.5);
//			ImageJDKUtil.scaleRateImageFile("F:/Document/My Pictures/复件 1.gif", "G:/2.gif", 300, 300);
//			ImageJDKUtil.scaleFixedImageFile("F:/Document/My Pictures/复件 1.gif", "G:/3.gif", 300, 300, false);
