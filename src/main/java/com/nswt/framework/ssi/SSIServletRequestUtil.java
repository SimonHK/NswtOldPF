...
public class SSIServletRequestUtil {
	 ...
	 * current context (i.e. too many ".." path elements are present), return <code>null</code> instead. This normalize
	 * should be the same as DefaultServlet.normalize, which is almost the same ( see source code below ) as
	 * RequestUtil.normalize. Do we need all this duplication?
	 * 
