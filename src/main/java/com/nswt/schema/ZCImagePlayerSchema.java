...
public class ZCImagePlayerSchema extends Schema {
	...
	protected static final String _UpdateAllSQL = "update ZCImagePlayer set ID=?,Name=?,Code=?,SiteID=?,StyleID=?,ImageSource=?,RelaCatalogInnerCode=?,Height=?,Width=?,DisplayCount=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";
