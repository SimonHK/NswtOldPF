...
/**
 * 表名称：企业承诺<br>
 * 表代码：ZCCommEnterprise<br>
 * 表主键：ID<br>
 */
public class ZCCommEnterpriseSchema extends Schema {
	private Long ID;
	...
	public static final String _TableCode = "ZCCommEnterprise";

	public static final String _NameSpace = "com.nswt.schema";

	protected static final String _InsertAllSQL = "insert into ZCCommEnterprise values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update ZCCommEnterprise set ID=?,FullName=?,ShortName=?,EnterpriseUrl=?,Place=?,LegalPerson=?,EnterpriseType=?,CommDate=?,CommWord=?,CommWordUrl=?,SiteID=?,VoteCount=?,Prop1=?,prop2=?,Prop3=?,Prop4=?,Prop5=?,Prop6=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";

	protected static final String _DeleteSQL = "delete from ZCCommEnterprise  where ID=?";

	protected static final String _FillAllSQL = "select * from ZCCommEnterprise  where ID=?";

	public ZCCommEnterpriseSchema(){
	...
	protected Schema newInstance(){
		return new ZCCommEnterpriseSchema();
	}
	...
	public ZCCommEnterpriseSet query() {
		return query(null, -1, -1);
	}

	public ZCCommEnterpriseSet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public ZCCommEnterpriseSet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public ZCCommEnterpriseSet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (ZCCommEnterpriseSet)querySet(qb , pageSize , pageIndex);
	}
