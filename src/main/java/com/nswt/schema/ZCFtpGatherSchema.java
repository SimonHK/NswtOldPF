 ...
 * 表主键：ID<br>
 */
public class ZCFtpGatherSchema extends Schema {
	private Long ID;
	...
	public static final String _TableCode = "ZCFtpGather";

	public static final String _NameSpace = "com.nswt.schema";

	protected static final String _InsertAllSQL = "insert into ZCFtpGather values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

	protected static final String _UpdateAllSQL = "update ZCFtpGather set ID=?,Name=?,FtpHost=?,FtpPort=?,GatherDrectory=?,FtpUserName=?,FtpUserPassword=?,GatherType=?,Title=?,RedirectUrl=?,Content=?,SiteID=?,CatalogID=?,Type=?,ConfigXML=?,ProxyFlag=?,ProxyHost=?,ProxyPort=?,Status=?,Prop1=?,Prop2=?,Prop3=?,Prop4=?,Prop5=?,Prop6=?,AddUser=?,AddTime=?,ModifyUser=?,ModifyTime=? where ID=?";

	protected static final String _DeleteSQL = "delete from ZCFtpGather  where ID=?";

	protected static final String _FillAllSQL = "select * from ZCFtpGather  where ID=?";

	public ZCFtpGatherSchema(){
	...
	public ZCFtpGatherSet query() {
		return query(null, -1, -1);
	}

	public ZCFtpGatherSet query(QueryBuilder qb) {
		return query(qb, -1, -1);
	}

	public ZCFtpGatherSet query(int pageSize, int pageIndex) {
		return query(null, pageSize, pageIndex);
	}

	public ZCFtpGatherSet query(QueryBuilder qb , int pageSize, int pageIndex){
		return (ZCFtpGatherSet)querySet(qb , pageSize , pageIndex);
	}
